...
`endif
  ...
  (* keep_hierarchy = "TRUE" *) BufferCC_3 io_asyncReset_buffercc (
  ...
  MuraxMasterArbiter system_mainBusArbiter (
    ...
    .io_dBus_cmd_valid                (dBus_cmd_halfPipe_valid                                           ), //i
    .io_dBus_cmd_ready                (system_mainBusArbiter_io_dBus_cmd_ready                           ), //o
    .io_dBus_cmd_payload_wr           (dBus_cmd_halfPipe_payload_wr                                      ), //i
    .io_dBus_cmd_payload_mask         (dBus_cmd_halfPipe_payload_mask[3:0]                               ), //i
    .io_dBus_cmd_payload_address      (dBus_cmd_halfPipe_payload_address[31:0]                           ), //i
    .io_dBus_cmd_payload_data         (dBus_cmd_halfPipe_payload_data[31:0]                              ), //i
    .io_dBus_cmd_payload_size         (dBus_cmd_halfPipe_payload_size[1:0]                               ), //i
  ...
  assign system_cpu_dBus_cmd_ready = (! dBus_cmd_rValid);
  ...
  assign dBus_cmd_halfPipe_ready = system_mainBusArbiter_io_dBus_cmd_ready;
  assign system_cpu_debug_bus_cmd_payload_address = systemDebugger_1_io_mem_cmd_payload_address[7:0];
  assign debug_bus_cmd_fire = (systemDebugger_1_io_mem_cmd_valid && system_cpu_debug_bus_cmd_ready);
  ...
  assign system_mainBusDecoder_logic_hits_0 = ((system_mainBusDecoder_logic_masterPipelined_cmd_payload_address & (~ 32'h000007ff)) == 32'h80000000);
  always @(*) begin
  ...
  always @(posedge io_mainClk) begin
    if(system_cpu_dBus_cmd_ready) begin
      dBus_cmd_rData_wr <= system_cpu_dBus_cmd_payload_wr;
      dBus_cmd_rData_mask <= system_cpu_dBus_cmd_payload_mask;
      dBus_cmd_rData_address <= system_cpu_dBus_cmd_payload_address;
      dBus_cmd_rData_data <= system_cpu_dBus_cmd_payload_data;
      dBus_cmd_rData_size <= system_cpu_dBus_cmd_payload_size;
    end
  ...
  always @(posedge io_mainClk) begin
    debug_resetOut_regNext <= system_cpu_debug_resetOut;
  end
...
module MuraxPipelinedMemoryBusRam (
  ...
  wire       [8:0]    _zz_io_bus_rsp_payload_data_2;
  ...
  assign _zz_io_bus_rsp_payload_data_2 = _zz_io_bus_rsp_payload_data[8:0];
  always @(*) begin
